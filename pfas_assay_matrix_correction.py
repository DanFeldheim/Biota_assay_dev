...
class Flow_Control():
    ...
    def all_calls(self):
        ...
        matrix_adjusted_rfu_dict = conc_calcs.analyze_matrix(drift_adjusted_rfu_dict, self.params_dict)
...
class Calculate_Concs():
    ...
    def analyze_matrix(self,
        ...
        """
        Apply a sample-matrix correction using std3 as a single-point anchor.
